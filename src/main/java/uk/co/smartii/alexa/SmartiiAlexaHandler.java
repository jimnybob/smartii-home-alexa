 ...
 */
public class SmartiiAlexaHandler {
    ...
    public void handleRequest2(InputStream inputStream, OutputStream outputStream, Context context) throws IOException
    {
        ...
        log(IOUtils.toString(inputStream, Charset.forName("utf-8")));
